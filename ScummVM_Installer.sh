...
then
	...
	installDEBS "$DEB_REPO/libt/libtheora|libtheora0_1.1.1%2Bdfsg.1-15|lib*|3|$INSTALL_DIR"
	...
	installDEBS "$DEB_REPO/libx/libxext|libxext6_1.3.3-1%2Bb2|lib*|3|$INSTALL_DIR"
