...
Install_ScummVM.ini (options)
	  ...
	  BBOND007_SCUMMVM29="FALSE"               (TRUE to install ScummVM 2.9)
      BBOND007_SCUMMVM29_UNSTABLE="FALSE"      (TRUE to install ScummVM 2.9 with work-in-progress game engines enabled)
	  ...
	  BBOND007_SCUMMVM280="TRUE"               (TRUE to install ScummVM 2.8.0)
      BBOND007_SCUMMVM280_UNSTABLE="FALSE"     (TRUE to install ScummVM 2.8.0 with work-in-progress game engines enabled)
      BBOND007_SCUMMVM281="TRUE"               (TRUE to install ScummVM 2.8.1)
      BBOND007_SCUMMVM281_UNSTABLE="FALSE"     (TRUE to install ScummVM 2.8.1 with work-in-progress game engines enabled)
	  BBOND007_SCUMMVM290="TRUE"               (TRUE to install ScummVM 2.9.0)
      BBOND007_SCUMMVM290_UNSTABLE="FALSE"     (TRUE to install ScummVM 2.9.0 with work-in-progress game engines enabled)
	  BBOND007_SCUMMVM291="TRUE"               (TRUE to install ScummVM 2.9.0)
      BBOND007_SCUMMVM291_UNSTABLE="FALSE"     (TRUE to install ScummVM 2.9.0 with work-in-progress game engines enabled)
	  BBOND007_SCUMMVM30="TRUE"                (TRUE to install ScummVM 3.0)
      BBOND007_SCUMMVM30_UNSTABLE="FALSE"      (TRUE to install ScummVM 3.0 with work-in-progress game engines enabled)
	  BBOND007_SCUMMVM202610="TRUE"            (TRUE to install ScummVM 2026.1.0)
      BBOND007_SCUMMVM202610_UNSTABLE="FALSE"  (TRUE to install ScummVM 2026.1.0 with work-in-progress game engines enabled)
